...
export class ErrorBoundary extends React.Component<Props, State> {
  ...
  // The previous constructor-based initialization was causing a build issue where TypeScript could not find `this.state` or `this.props`.
  // Class property syntax is more modern and avoids such `this` context issues.
  ...
  // FIX: Converted to an arrow function to lexically bind `this`.
  // This resolves an unusual build error where `this.props` was not being found on the class instance.
  render = () => {
